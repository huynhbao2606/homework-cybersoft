...
public class BaiTap1 {
    public static void main(String[] args) {
        ...
        int key = sc.nextInt();
        if(key < 1){
            System.out.println("Vui lòng nhập số bài lớn hơn 1");
        }
        switch (key) {
            case 1 :
                Bai1();
    ...
    public static void Bai4(){
        ...
        System.out.printf("Giá trị trung binh của 5 số là : %.2f", tinhTrungBinh);
    }
    ...
    public static void Bai5(){
        ...
        System.out.printf("Độ C Sang F là : %.2fF", doF);
    }
    ...
    public static void Bai6(){
        ...
        System.out.printf("Số tiền USD sang VND là: %.2f", toVnd);
    }
}
